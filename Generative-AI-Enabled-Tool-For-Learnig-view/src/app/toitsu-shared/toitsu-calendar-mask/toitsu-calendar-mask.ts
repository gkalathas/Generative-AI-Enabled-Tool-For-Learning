...
import { ToitsuCalendarMaskingBase } from './toitsu-calendar-masking-base';

@Directive({
    selector: "p-calendar[pCalendarMask]"
})
export class ToitsuCalendarMaskDirective extends ToitsuCalendarMaskingBase implements AfterViewChecked, OnDestroy {
